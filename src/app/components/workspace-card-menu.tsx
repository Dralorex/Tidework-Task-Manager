  ...
  return (
    ...
    >
      <button
        ...
        className="rounded-md px-2 py-1 text-[#0A3D45]/45 transition hover:bg-[#0A3D45]/8 hover:text-[#0A3D45]"
        onClick={(e) => {
          e.preventDefault();
          e.stopPropagation();
          setOpen((v) => !v);
      ...
      {open ? (
        <div
          className="absolute right-0 z-30 mt-1 w-64 rounded-lg border border-[#0A3D45]/12 bg-[#E8F7F6] py-1 shadow-md"
          role="menu"
        >
          {panel === "menu" ? (
            <>
